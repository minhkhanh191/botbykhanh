...
module.exports.languages = {
    "vi": {
        ...
        "myself": "Bé iu của Bot đã hót được %2 tin nhắn và đứng hạng %1 !\nChơi đẹp đi, Spam là chó 😾"
    },
    "en": {
...
module.exports.run = async function ({ args, api, event, Currencies, getText }) {
    ...
    try {
        ...
        if (args[0] == "all") {
            ...
            page < -1 ? page = 1 : "";
            var limit = 25 ;
            var msg = "✉ 𝙏𝙊𝙋 𝙏𝙐̛𝙊̛𝙉𝙂 𝙏𝘼́𝘾 𝙏𝙍𝙊𝙉𝙂 𝘽𝙊𝙓:\n";
            ...
            msg += `               ❧ Trang ${page}/${numPage} ☙\n☞ Dùng "${global.config.PREFIX}checktt all + [số trang]" để xem các trang sau!`
